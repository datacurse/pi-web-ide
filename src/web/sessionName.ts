 ...
 * unsee — and there are three sources to reconcile: a name omp holds (either
 * set by hand through the rename control or generated by omp's own titler),
 * the first user message, and, for a session with neither, the file.
 */
 ...
 * item, which hands the job to omp's own titler.
 */
